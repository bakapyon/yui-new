    ...
    button.addEventListener('click', (event) => {
        ...
        if (command) {
            ...
            if (command === 'clear') {
                ...
                output.value += `Admin@YuiBOT:~$ ${command}\n`;
