...
/**
 * Estrutura de dados que descreve as configurações padrões de um comando, módulo ou função criados no Projeto Yui.
 ...
 * @property {Object} card - Determina se Yui deve enviar cartões de nível sempre que alguém atingir um novo nível.
...
/**
  ...
  * @property {boolean} isBotGroupAdmins - Indica se a Yui é um administrador do grupo.
  ...
  * @property {boolean} isBot - Indica se a mensagem foi enviada pela Yui.
