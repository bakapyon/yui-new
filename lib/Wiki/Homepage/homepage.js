...
function checkCheatCode(input) {
    ...
    if (typeof cheat.action === 'string') {
        ...
        /* Se for sobre o grupo da Yui */
    } else if (cheat.cheat.includes('horizon')) {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    /*
        Efeito de fogos de artificio e aniversário da Yui
    ...
    */
    footerEvent.addEventListener('click', () => {
        ...
        if (showEvent && !isFirework) {
            ...
            setTimeout(() => {
                /* Define a mensagem e imagem de niver da Yui se for dezembro */
                    ...
                    if (chanceGlitch) {
                        ...
                        setTimeout(() => {
                            ...
                            setTimeout(() => {
                                ...
                                document.querySelector('#navbar > a').innerText = 'PROJETO Yui';
